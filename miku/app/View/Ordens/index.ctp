<div class="ordens index">
	...
	<tr>
		...
		<td><?php echo h($orden['Orden']['comentario']); ?>&nbsp;</td>
		<td><?php echo h($orden['Orden']['created']); ?>&nbsp;</td>
		<td><?php echo h($orden['Orden']['modified']); ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $orden['Orden']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $orden['Orden']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $orden['Orden']['id']), array(), __('Are you sure you want to delete # %s?', $orden['Orden']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
